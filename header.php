	...
	<div class="pintper-row">
		...
		<div class="pintper-col-15">
			<div class="pintper-iniciar-sesion-container">
				<a href="#">
					<svg version="1.1" baseProfile="basic" id="user-icon"
						xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512"
						xml:space="preserve">
					<path id="user-icon" d="M96.2,351.9c-20.7,20.7-37,44.9-48.4,71.8C36,451.6,30,481.2,30,511.7h38.1c0-103.8,84.1-187.9,187.9-187.9
