...
<body>
	...
	<div class="login-usuario">
			...
			<div class="contenedor-izquierda propietario-contenedor-derecha">
				<h1>PINTPER</h1>
				<p>Para dueños de locales</p>
			...
			<div class="contenedor-derecha">
				...
				<div class="registrar-link">
					<!-- <p>No sos miembro?  <a href="usuario/registroview"> registrate!</a></p> -->
				</div>
				...
				<div class="form-iniciar-sesion">
					...
					<div class="contenedor-flex">
						...
						<form action="<?php echo constant('URL')?>propietario/login" method="post" onsubmit="return validar();">
							...
							<label for="claveUsuario">Clave</label> <br>
