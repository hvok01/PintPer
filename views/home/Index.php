...
<body>
	...
	<div class="contenedor-index">
		...
		<button class="pintper-button-op2"><a href="<?php echo constant('URL')?>usuario">Busco birra</a></button>

		<button class="pintper-button-op2"><a href="<?php echo constant('URL')?>propietario">Hago birra</a></button>
	...
	<div class="grid-seccion-1">
		...
		<div class="section-1-2">
			...
			<button class="pintper-button-op2">
				<a href="<?php echo constant('URL')?>propietario"> Registrate hoy!
				</a>
			</button>
		</div> 
	</div>
	...
	<div class="grid-seccion-2">
		...
		<div class="section-2-2">
			...
			<button class="pintper-button-op2">
				<a href="<?php echo constant('URL')?>usuario"> Registrate hoy!
				</a>
			</button>
		</div>
	</div>
